...
type test struct {
	input ts.TwoSumSolver
	wait  []int
}

var tests = []test{

	{ts.NewGivenNums([]int{2, 7, 11, 15}, 9), []int{0, 1}},
	{ts.NewGivenNums([]int{0, 1, 2, 3, 999, 9}, 9), []int{0, 5}},
	{ts.NewGivenNums([]int{0, 1, 2, 3, 4, 5}, 3), []int{0, 3}},
	{ts.NewGivenNums([]int{0, 11, 12, 343, 4}, 343), []int{0, 3}},
	{ts.NewGivenNums([]int{9, 9, 3}, 12), []int{0, 2}},
}
